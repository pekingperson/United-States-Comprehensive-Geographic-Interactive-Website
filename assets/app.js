...
const BOUNDARY_URL = "data/urban-area-boundaries.json?v=20260515-urban-merge-additions";
...
async function init() {
  ...
  state.index = await fetchJsonWithRetry("data/urban-areas.json?v=20260515-urban-merge-additions", { cache: "force-cache" });
