...
const BOUNDARY_URL = "data/urban-area-boundaries.json?v=20260515-salt-lake-urban-merge";
...
async function init() {
  ...
  state.index = await fetchJsonWithRetry("data/urban-areas.json?v=20260515-salt-lake-urban-merge", { cache: "force-cache" });
