...
const BOUNDARY_URL = "data/urban-area-boundaries.json?v=20260515-denver-urban-additions";
...
async function init() {
  ...
  state.index = await fetchJsonWithRetry("data/urban-areas.json?v=20260515-denver-urban-additions", { cache: "force-cache" });
