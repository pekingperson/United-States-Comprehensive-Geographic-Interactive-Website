...
const BOUNDARY_URL = "data/urban-area-boundaries.json?v=20260515-stl-seattle-urban-merges";
...
async function init() {
  ...
  state.index = await fetchJsonWithRetry("data/urban-areas.json?v=20260515-stl-seattle-urban-merges", { cache: "force-cache" });
