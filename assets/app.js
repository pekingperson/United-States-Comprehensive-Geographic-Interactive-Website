...
const BOUNDARY_URL = "data/urban-area-boundaries.json?v=20260515-sf-denver-urban-merges";
...
async function init() {
  ...
  state.index = await fetchJsonWithRetry("data/urban-areas.json?v=20260515-sf-denver-urban-merges", { cache: "force-cache" });
